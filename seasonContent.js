        ...
        nodes: [
          {
            ...
            questions: [
              ...
              { text: "According to the coursepack's Literary Format table, what comes right after 'A Command' in each day's structure?", choices: ["Accomplishment of the Command", "An Identification of the Day", "Affirmation of Goodness", "Introduction"], correctIndex: 0 },
              { text: "According to the coursepack's Fixed Format, what do the first three days of creation accomplish?", choices: ["Separation", "Decoration or population", "Destruction", "Rest"], correctIndex: 0 },
              { text: "What Babylonian creation epic does the coursepack contrast with the biblical creation account?", choices: ["Enuma Elish", "The Epic of Gilgamesh", "The Code of Hammurabi", "The Book of the Dead"], correctIndex: 0 },
              { text: "According to the coursepack, how does the biblical account of creation differ from the Enuma Elish?", choices: ["God creates by His Divine Goodness and loving Design, not through combat between gods", "Both accounts describe the exact same battle between gods", "The biblical account also involves a slain goddess", "There is no meaningful difference between the two"], correctIndex: 0 },
              { text: "According to the coursepack, what does the 'heaven(s) + earth' formula represent in biblical writing?", choices: ["The whole world or universe", "Only the sky above Israel", "A place that does not really exist", "The underworld alone"], correctIndex: 0 },
              { text: "According to the coursepack, why does God 'rest' on the seventh day even though He continues to sustain creation?", choices: ["To point toward the eternal rest and joy of union with God, not because God stopped working", "Because God grew tired from His labor", "Because the seventh day marks the end of God's care for creation", "Because rest was unnecessary until humans were created"], correctIndex: 0 },
              { text: "According to the coursepack, why does darkness in the creation story ultimately serve a purpose rather than remaining pure chaos?", choices: ["Because God gives it a role within the rhythm of life, offering rest and renewal", "Because darkness is stronger than God's light", "Because darkness was created by a rival god", "Because darkness has no connection to the story at all"], correctIndex: 0 }
            ]
          },
          {
        ...
        nodes: [
          {
            ...
            questions: [
              ...
              { text: "According to the coursepack, why is the 'image and likeness' of God in Genesis 1:26-27 NOT about physical appearance?", choices: ["Because God is Pure Spirit, so the image reflects spiritual qualities like reason, love, and compassion", "Because Adam had no physical body at first", "Because the text was written after Adam's death", "Because only angels can bear God's image"], correctIndex: 0 },
              { text: "According to the coursepack, what are the two ancient traditions that together give a complementary picture of the human person?", choices: ["The Priestly tradition (Gen 1:26-27) and the Yahwist tradition (Gen 2:4b-25)", "The Deuteronomist tradition and the Elohist tradition only", "The Exodus tradition and the Wisdom tradition", "The Prophetic tradition and the Apocalyptic tradition"], correctIndex: 0 },
              { text: "According to the Catholic Catechism (CCC 357), quoted in the coursepack, what does it mean that a human being is never merely an object?", choices: ["A human being is always a subject — 'someone' as opposed to 'something'", "A human being is a tool for God's other purposes", "A human being has no real identity of their own", "A human being's worth depends on their usefulness"], correctIndex: 0 },
              { text: "In the Yahwist symbolism, what does 'the Clay' represent about the human person?", choices: ["Kinship with the rest of God's creation", "A punishment for disobedience", "The absence of any real dignity", "A separation from the natural world"], correctIndex: 0 },
              { text: "In the Yahwist symbolism, what does 'the Breath of God' (Ruah) represent about the human person?", choices: ["Kinship with God Himself", "A curse placed on humanity", "Physical strength alone", "A reward for good behavior"], correctIndex: 0 },
              { text: "According to the coursepack, what three gifts did God bestow on humanity at creation?", choices: ["Land, Freedom, and Justice", "Wealth, Power, and Fame", "Wisdom, Courage, and Beauty", "Peace, War, and Judgment"], correctIndex: 0 },
              { text: "According to the coursepack, what right did the Israelites have over the land, as opposed to strict ownership?", choices: ["The right to use and enjoy its fruits (usufruct), while Yahweh remains the true owner", "Full and permanent private ownership with no restrictions", "No right to the land at all", "Ownership only during wartime"], correctIndex: 0 }
            ]
          },
          {
        ...
        nodes: [
          {
            ...
            questions: [
              ...
              { text: "According to the coursepack, which four Hebrew terms are closely related to biblical justice?", choices: ["Tsedaqah, mishpat, ḥesed, and 'emet", "Torah, Talmud, Mishnah, and Midrash", "Shalom, Ruach, Berit, and Qahal", "Elohim, Adonai, YHWH, and El Shaddai"], correctIndex: 0 },
              { text: "What does 'mishpat' specifically stress in the biblical understanding of justice?", choices: ["The right structure of society", "Unwavering love and mercy alone", "Truth and faithfulness alone", "Personal wealth and status"], correctIndex: 0 },
              { text: "Who are the 'anawim,' the group especially central to the biblical vision of social justice?", choices: ["The weak, the poor, and the oppressed", "Kings and religious leaders", "Wealthy landowners", "Foreign conquerors"], correctIndex: 0 },
              { text: "According to Genesis 18:19, quoted in the coursepack, what task were the Patriarchs given?", choices: ["To practice righteousness and justice (Tsedaqah and Mishpat)", "To build the first Temple", "To conquer neighboring nations", "To establish a monarchy immediately"], correctIndex: 0 },
              { text: "According to the coursepack, why was the expulsion from Eden considered a fair punishment rather than a cruel one?", choices: ["Because humanity tried to take what was rightfully God's", "Because Adam and Eve asked to leave the garden", "Because the garden was too small for them", "Because God no longer wanted to be their Creator"], correctIndex: 0 },
              { text: "In the story of the first murder in Genesis 4, what does the coursepack say 'cries out for justice'?", choices: ["The blood of Abel from the soil", "The voice of the serpent", "The silence of the garden", "The tears of Eve"], correctIndex: 0 },
              { text: "According to the coursepack, what characterized Jesus' ministry of justice toward the anawim?", choices: ["He challenged oppressive systems and brought good news to the poor", "He avoided any conflict with religious authorities", "He focused only on ritual purity laws", "He limited his ministry strictly to the wealthy"], correctIndex: 0 }
            ]
          },
          {
        ...
        nodes: [
          {
            ...
            questions: [
              ...
              { text: "According to the coursepack, what do Adam and Eve symbolize in the Genesis 3 narrative?", choices: ["The entire human race, not just two individuals", "Two unrelated historical figures", "Only the priestly class of Israel", "The nation of Egypt"], correctIndex: 0 },
              { text: "In the coursepack's interpretation, what does the snake/serpent in Genesis 3 primarily symbolize?", choices: ["Human goodness — life, fertility, and wisdom — when left unbridled", "A literal demon with no symbolic meaning", "The nation of Babylon", "An angel sent to test Adam and Eve"], correctIndex: 0 },
              { text: "According to the coursepack, what are the 'two dangers of human goodness'?", choices: ["Doing good that turns out wrong, and desiring goodness excessively", "Being too weak and being too strong", "Loving God too much and loving neighbor too little", "Praying too often and fasting too rarely"], correctIndex: 0 },
              { text: "What does the coursepack call an excessive, superfluous yearning for goodness?", choices: ["Irascibility", "Humility", "Chastity", "Sobriety"], correctIndex: 0 },
              { text: "According to the coursepack, what does the Tree in the middle of the Garden ultimately represent about God?", choices: ["God's absolute goodness and sole authority over life", "A literal source of poison", "A boundary meant to be crossed freely", "A symbol with no theological significance"], correctIndex: 0 },
              { text: "According to the coursepack, where does evil originate if God is the source of all goodness?", choices: ["It arises when human goodness is misused, unbridled, or overextended into God's domain", "It is created directly by God as a test", "It has always existed independently of God", "It originates from the animals God created"], correctIndex: 0 },
              { text: "According to the coursepack, what does the Genesis 3 narrative ultimately demonstrate about the source of evil?", choices: ["That the failure of humanity, not God, is the source of evil", "That evil and God are equally powerful forces", "That evil was created before humanity existed", "That evil is unrelated to human freedom"], correctIndex: 0 }
            ]
          },
          {
        ...
        nodes: [
          {
            ...
            questions: [
              ...
              { text: "According to the coursepack, what realization in Genesis 3:7 signals humanity's alienation from itself?", choices: ["The realization that they were naked", "The realization that they were hungry", "The realization that they could no longer speak", "The realization that they had grown old"], correctIndex: 0 },
              { text: "In the ancient world, what did nakedness in front of others often symbolize, as referenced in the coursepack?", choices: ["Vulnerability and humiliation, as with captured soldiers", "Wealth and royal status", "A sign of divine favor", "A rite of passage into adulthood"], correctIndex: 0 },
              { text: "According to the coursepack, how does Adam respond when God confronts him in Genesis 3:12?", choices: ["He shifts blame onto Eve, and implicitly onto God", "He confesses immediately and asks forgiveness", "He blames the serpent directly", "He remains completely silent"], correctIndex: 0 },
              { text: "According to biblical scholar Gerhard von Rad, sin causes estrangement from God and from others in what two directions?", choices: ["Vertically and horizontally", "Spiritually and physically only", "Nationally and internationally", "Temporally and eternally"], correctIndex: 0 },
              { text: "According to the coursepack, what does humanity's call to care for creation (Gen 2:15) require, in contrast to what happens after the fall?", choices: ["Faithful stewardship, though humans often destroy creation instead", "Total abandonment of the land", "Worship of nature as divine", "Complete indifference to the environment"], correctIndex: 0 },
              { text: "What does the CBCP's pastoral letter 'What is Happening to Our Beautiful Land' call the destruction of forests, rivers, and seas?", choices: ["The rape of Mother Earth", "A necessary sacrifice for progress", "An unavoidable natural cycle", "A blessing in disguise"], correctIndex: 0 },
              { text: "According to the coursepack, what does Cain's refusal to be 'his brother's keeper' (Gen 4:9) reveal about sin?", choices: ["That sin spreads and corrupts relationships between people, not just with God", "That sin is limited to one person and never spreads", "That sin only affects the person who commits it", "That sin has no connection to relationships at all"], correctIndex: 0 }
            ]
          },
          {
        ...
        nodes: [
          {
            ...
            questions: [
              ...
              { text: "According to the coursepack, what does 'social sin' refer to more precisely?", choices: ["Conditions, institutions, or systems that perpetuate, tolerate, or ignore evil", "Sin committed exclusively during large public gatherings", "A sin with no real spiritual consequence", "A term found only in modern secular law"], correctIndex: 0 },
              { text: "Which commandment does the sin of idolatry directly violate, according to the coursepack?", choices: ["The First Commandment: 'You shall have no other gods before Me'", "The Fourth Commandment on honoring parents", "The Sixth Commandment on adultery", "The Eighth Commandment on false witness"], correctIndex: 0 },
              { text: "According to the coursepack, what happens when a belief system reworks doctrine to fit cultural or personal preference?", choices: ["This is the sin of Heresy", "This is the sin of Blasphemy", "This is considered acceptable adaptation", "This is called Apostasy alone"], correctIndex: 0 },
              { text: "According to the coursepack, what characterizes the sin of hypocrisy?", choices: ["Appearing morally upright outwardly while being corrupt inwardly", "Refusing to ever attend religious services", "Publicly confessing every personal fault", "Following religious law too strictly"], correctIndex: 0 },
              { text: "According to the coursepack, blasphemy is described as violating which commandment?", choices: ["The Second Commandment: 'You shall not take the name of the Lord your God in vain'", "The Fifth Commandment on killing", "The Seventh Commandment on stealing", "The Tenth Commandment on coveting"], correctIndex: 0 },
              { text: "According to the Catholic Catechism (CCC 27), quoted in the coursepack, why is the desire for God 'written in the human heart'?", choices: ["Because man was created by God and for God, who never ceases to draw him", "Because ancient philosophers invented the idea", "Because humans fear death and invented religion to cope", "Because it was added later by Church councils"], correctIndex: 0 },
              { text: "According to St. Augustine, quoted in the coursepack, why does the human heart remain 'restless'?", choices: ["Because it was made for God and only rests when united with Him", "Because sleep is naturally difficult for humans", "Because material wealth is never truly satisfying on its own", "Because human life is inherently short"], correctIndex: 0 }
            ]
          },
          {
        ...
        nodes: [
          {
            ...
            questions: [
              ...
              { text: "According to the coursepack, what Greek word related to 'salvation' refers to a healing ointment used to treat wounds?", choices: ["Salve", "Malkuth", "Ruah", "Logos"], correctIndex: 0 },
              { text: "According to the coursepack, the 'common' understanding of salvation (soul's deliverance for heaven) was heavily shaped by which philosophical influence?", choices: ["Greco-Roman Neo-Platonic and Aristotelian philosophy", "Ancient Egyptian mythology", "Modern scientific materialism", "Confucian ethics"], correctIndex: 0 },
              { text: "According to the coursepack's comparison table, how does the biblical view of 'Salvation from Sin' differ from the common view?", choices: ["It includes salvation from ALL human evils — disease, hunger, poverty, death, war, and oppression", "It focuses only on the forgiveness of personal sin", "It denies that sin needs to be forgiven at all", "It applies only to the sins of Israel's ancestors"], correctIndex: 0 },
              { text: "For the Hebrews/Israelites (ca. 2000-586 BCE), how was salvation primarily experienced, according to the coursepack?", choices: ["As a historical and tangible reality — land, food, freedom, and prosperity", "As a purely mystical experience with no connection to daily life", "As something achieved only through animal sacrifice", "As irrelevant until after death"], correctIndex: 0 },
              { text: "Which prophet is cited in the coursepack as proclaiming a 'new Exodus' for the exiles in Babylon?", choices: ["Deutero-Isaiah", "Amos", "Jonah", "Malachi"], correctIndex: 0 },
              { text: "According to the coursepack, what vision of ultimate salvation do the Jewish Apocalyptic writers emphasize?", choices: ["A 'new heaven and a new earth' with no more death or suffering", "A return to slavery in Egypt", "The destruction of Jerusalem", "The abolition of the Ten Commandments"], correctIndex: 0 },
              { text: "According to 1 Corinthians 15:28, quoted in the coursepack, what is the ultimate goal of Total Salvation?", choices: ["That God will be 'all in all'", "That Israel alone will be saved", "That the soul will finally cease to exist", "That the earth will be destroyed permanently"], correctIndex: 0 }
            ]
          },
          {
        ...
        nodes: [
          {
            ...
            questions: [
              ...
              { text: "According to the coursepack, where did Abram's family originate before migrating toward Canaan?", choices: ["Ur of the Chaldeans", "Jerusalem", "Nineveh", "Damascus"], correctIndex: 0 },
              { text: "According to the coursepack, what three fundamental promises did God make in His covenant with Abraham?", choices: ["A specific land, many descendants, and a unique nation", "Wealth, military power, and a throne", "Eternal youth, victory in war, and fame", "A temple, a priesthood, and a written law"], correctIndex: 0 },
              { text: "What sign did Abraham receive to formally seal his covenant with Yahweh, according to the coursepack?", choices: ["Circumcision", "Baptism", "A burnt offering only", "A pilgrimage to Jerusalem"], correctIndex: 0 },
              { text: "According to the coursepack, how did Joseph end up saving his family from famine?", choices: ["He rose to become Pharaoh's trusted aide overseeing Egypt's grain supply", "He led a military conquest of Egypt", "He married into Pharaoh's family", "He built the pyramids as a food storage system"], correctIndex: 0 },
              { text: "According to the coursepack, what does the name 'Moses' mean, and what does it theologically represent?", choices: ["'Drawn out from the water,' representing divine intervention to save the oppressed", "'Chosen prince,' representing royal privilege", "'Wanderer,' representing a life without purpose", "'Fire-bearer,' representing destruction"], correctIndex: 0 },
              { text: "According to the coursepack, what act led Moses into exile in Midian as a 'guerilla fighter/human rights defender'?", choices: ["He killed an Egyptian overseer who was mistreating a Hebrew", "He refused to speak to Pharaoh", "He organized a peaceful protest", "He was banished by his own family"], correctIndex: 0 },
              { text: "According to the coursepack, what did Moses do as a 'teacher/conscienticizer' when he returned to Egypt?", choices: ["He helped the Hebrews become conscious of the injustice of their oppression", "He taught Pharaoh's court about Hebrew customs", "He wrote a new legal code for Egypt", "He avoided contact with the Hebrew slaves"], correctIndex: 0 }
            ]
          },
          {
        ...
        nodes: [
          {
            ...
            questions: [
              ...
              { text: "According to the coursepack, what does the name 'Joshua' mean?", choices: ["'God is salvation' or 'great warrior'", "'Chosen one of the desert'", "'Servant of Pharaoh'", "'Keeper of the covenant scroll'"], correctIndex: 0 },
              { text: "According to the coursepack, in how many key ways did the Israelites benefit from the covenant once they occupied Canaan?", choices: ["Four — possessing the land, becoming a nation, affirming identity as Qahal Yahweh, and self-governance", "Only one — military victory", "Two — wealth and fame", "None; the covenant offered no tangible benefit"], correctIndex: 0 },
              { text: "According to the coursepack, what happened to Israel's united kingdom after the death of Solomon?", choices: ["It divided into the northern kingdom of Israel and the southern kingdom of Judah", "It was immediately absorbed into the Roman Empire", "It expanded to conquer Egypt", "It remained fully united for centuries afterward"], correctIndex: 0 },
              { text: "According to the coursepack, what happened to the Northern Kingdom in 722 BCE?", choices: ["It was overrun by the Assyrian Empire, and many were exiled", "It successfully repelled all invaders", "It became the capital of a new empire", "It merged peacefully with Judah"], correctIndex: 0 },
              { text: "According to the coursepack, what does the Hebrew word 'Nabi' (prophet) mean?", choices: ["Both foretelling the future and 'telling forth' God's word publicly", "A royal title with no religious meaning", "A soldier who wages holy war", "A scribe who copies the Law"], correctIndex: 0 },
              { text: "According to the coursepack, who conquered Judah and exiled its people to Babylon in 587 BCE?", choices: ["Nebuchadnezzar", "Julius Caesar", "Alexander the Great", "Cyrus the Great"], correctIndex: 0 },
              { text: "According to the coursepack, who did the prophets show particular concern for, known as the Anawim?", choices: ["The poor and oppressed", "Foreign kings", "Wealthy merchants", "Military commanders"], correctIndex: 0 }
            ]
          },
          {
